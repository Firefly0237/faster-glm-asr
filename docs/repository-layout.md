...
An experiment may write local artifacts below an ignored directory, but any
public summary must contain only the minimum aggregate information permitted by
the input license and privacy policy. Generated numbers do not become source
truth merely because they are copied into Markdown.
